...
function generateResponse(event) {
    ...
    let context = 
        "You are a chatbot designed to assist with questions about module guides at UNIZULU. Respond in isiZulu only. Your goal is to answer the user's question about the module guide, based on their input, and explain clearly in isiZulu.";
    ...
    addMessage("⏳ Sicela ulinde imizuzwana embalwa...", false);
